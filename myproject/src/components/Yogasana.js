...
import background from "../data/yoga3.jpg";
...
<Navbar>
  ...
  <ListGroup>
<Link class="list-group-item px-3 border-2 rounded-3 list-group-item-warning mb-2" tag="a" to="/yoga" action>Yogasana</Link>
